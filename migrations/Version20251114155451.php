 ...
 */
final class Version20251114155451 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create service_clicks and product_orders tables for statistics tracking';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE product_orders (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, product_reference VARCHAR(255) DEFAULT NULL, product_title VARCHAR(500) NOT NULL, customer_email VARCHAR(255) DEFAULT NULL, customer_phone VARCHAR(50) NOT NULL, order_type VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, user_agent VARCHAR(500) DEFAULT NULL, ip_address VARCHAR(45) DEFAULT NULL, INDEX idx_product_id (product_id), INDEX idx_order_type (order_type), INDEX idx_created_at (created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service_clicks (id INT AUTO_INCREMENT NOT NULL, service_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, user_agent VARCHAR(500) DEFAULT NULL, ip_address VARCHAR(45) DEFAULT NULL, INDEX idx_service_name (service_name), INDEX idx_created_at (created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE service_clicks');
